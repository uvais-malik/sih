...
const translations: Record<string, Record<Language, string>> = {
  ...
  voice_assistance_toggle: { hi: "आवाज सहायता", en: "Voice Assistance", pa: "ਆਵਾਜ਼ ਸਹਾਇਕ" },
  ...
  market_prices_page_subtitle: { hi: "भारत भर की प्रमुख मंडियों से वास्तविक समय में फसल की कीमतों से अवगत रहें। अपनी फसल के लिए डेटा-आधारित निर्णय लें।", en: "Stay informed with real-time crop prices from major mandis across India. Make data-driven decisions for your harvest.", pa: "ਭਾਰਤ ਭਰ ਦੀਆਂ ਪ੍ਰਮੁੱਖ ਮੰਡੀਆਂ ਤੋਂ ਅਸਲ-ਸਮੇਂ ਦੀਆਂ ਫਸਲਾਂ ਦੀਆਂ ਕੀਮਤਾਂ ਨਾਲ ਸੂਚਿਤ ਰਹੋ। ਆਪਣੀ ਫਸਲ ਲਈ ਡਾਟਾ-ਅਧਾਰਿਤ ਫੈਸਲੇ ਲਓ।" },
